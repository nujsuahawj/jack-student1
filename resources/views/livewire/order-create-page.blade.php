            ...
            <div class="card h-md-100">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <!-- button submit -->
                        @if ($allOrderLog && $allOrderLog->count() > 0)
                        <div class="row gx-2 gy-2 animate__animated animate__fadeIn">
                            ...
                            <div class="col-12 text-end">
                                <button wire:click='_doneOrder' class="btn btn-primary" style="border-radius: 30px;">ສັ່ງຊື້</button>
                            </div>
                        </div>
                        @else
