    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <div class="text-none">
            <div class="row gx-2 gy-2 mb-2">
                ...
                <div class="col-8">
                    <a href="/suppliers/create" wire:navigate class="btn btn-primary" style="border-radius: 30px;">
                    ...
                    <table class="table table-responsive table-hover">
                        ...
                        <tbody class="animate__animated animate__fadeIn">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/suppliers/edite/{{ $item->id }}" wire:navigate style="text-decoration: none; color: inherit;">
