<div>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        <div class="text-start">
            <h4>ແກ້ໄຂຂໍ້ມູນຜູ້ສະໜອງ</h4>
        </div>

        <div class="text-end">
            <a href="/suppliers" wire:navigate class="btn btn-outline-primary" style="border-radius: 30px;">
                ...
                <div class="card-body">
                    <form wire:submit="_updateUserData">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input wire:model="addName" type="text" class="form-control" placeholder="ຊື່ລູກຄ້າ" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <small class="form-text text-muted">
                            <div class="text-danger">
                                @error('addPhone')
